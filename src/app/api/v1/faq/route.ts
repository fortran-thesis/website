...
/**
 * GET /api/v1/faq
 * Get all FAQ entries with optional search
 * No authentication required - public endpoint
 * 
 * Query parameters:
 * - search: string (optional) - search query for question/answer
...
export async function GET(req: NextRequest) {
  try {
    ...
    const upstreamUrl = new URL(`${envOptions.apiUrl}/faq`);
    ...
    console.log('📤 GET /api/v1/faq proxy');
    ...
    console.error('GET /api/v1/faq proxy error:', error);
